...
COMMON_FLAGS :=  -g -mapcs-32 -mlittle-endian -fno-builtin
LOCAL_CPPFLAGS += -I$(TOP)/include 
LOCAL_CXXFLAGS += -D__cplusplus -fno-exceptions $(COMMON_FLAGS)
LOCAL_ASFLAGS += -w -D__ASSEMBLY__ $(COMMON_FLAGS)
...
ALL_MODULES.$(LOCAL_MODULE).OBJECTS := $(all_objects)
